...
import { deleteRoom } from "../../../app/store/Rooms/RoomsThunk";
...
const VisibleModalBox = ({setModalDelete, id}: props) => {
    ...
    const handleSubmit = async () => {
        await dispatch(deleteRoom(id._id));
    ...
    return (
        <ModalInfo>
                ...
                <p>Room data will be deleted and cannot be recovered! Are you sure you want to continue?</p>
                <div>
...
export function DeleteRoomModal({modalDelete, setModalDelete, id}: props) {
    return (
        <>
